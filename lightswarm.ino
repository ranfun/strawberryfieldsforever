...
char ssid[] = "RANFUN69";  //  your network SSID (name)
char pass[] = "saswat123";       // your network password
...
unsigned int localPort = 6969;      // local port to listen for UDP packets
...
void setup()
{
  ...
  // Serial.print (F(_TIME_));
  // Serial.print(F(" "));
  // Serial.println(F(_DATE_));
  // Serial.println();
  pinMode(0, OUTPUT);
